...
export default function SpeakerZx9() {
    return (
        <section className="px-4 md:px-10 xl:px-40">
            <section className="bg-moderate-orange rounded-lg h-[600px] p-1 ds:p-0 relative overflow-hidden ds:flex ds:items-center">
                ...
                <div className="w-[280px] mx-auto ds:mx-0 text-center ds:text-start flex flex-col gap-4 relative md:-mt-[90px] ds:mt-0">
